...
export function LoginPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center px-4">
      <div className="absolute inset-0 bg-gradient-to-br from-[#070b14] via-[#0b1226] to-[#101a2e]" />
      <div className="relative z-10 w-full max-w-md rounded-3xl border border-white/10 bg-[#101a2e]/80 p-8 shadow-soft backdrop-blur">
        <div className="mb-6">
