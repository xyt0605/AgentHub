...
export function WelcomeScreen() {
  ...
  const { sendMessage, isStreaming, cancelGeneration, thinkingLevel } =
    useChatStore();
  ...
  return (
    <div className="relative flex min-h-full items-center justify-center overflow-hidden px-4 py-16 sm:px-6">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute inset-0 bg-gradient-to-br from-cyan-500/[0.07] via-transparent to-violet-500/[0.09]"
      />
      <div
        aria-hidden="true"
      ...
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -top-32 right-[-40px] h-72 w-72 rounded-full bg-gradient-radial from-cyan-400/25 via-transparent to-transparent blur-3xl animate-float"
      />
      <div
        aria-hidden="true"
        className="pointer-events-none absolute -bottom-36 left-[-80px] h-80 w-80 rounded-full bg-gradient-radial from-violet-500/20 via-transparent to-transparent blur-3xl animate-float"
      />
      ...
      <div className="relative w-full max-w-[860px]">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-white/70 bg-[#0d1424]/70 px-3 py-1 text-xs font-medium text-violet-300 shadow-sm">
            <Bot className="h-3.5 w-3.5" />
            RAG 智能问答
          </span>
          <h1 className="mt-4 font-display text-4xl leading-tight tracking-tight text-zinc-100 sm:text-5xl md:text-6xl">
            把问题变成
        ...
        >
          <div
            className={cn(
              "relative flex flex-col rounded-3xl border border-white/70 bg-[#0d1424]/80 px-5 pt-4 pb-3 shadow-soft backdrop-blur-xl transition-all duration-200",
              isFocused
                ? "border-violet-400/60 shadow-glow"
          ...
          >
            <div className="relative">
              <textarea
                ...
                className="max-h-40 min-h-[52px] w-full resize-none border-0 bg-transparent px-2 pt-2 pb-2 text-[15px] text-zinc-100 placeholder:text-zinc-500 focus:outline-none sm:text-base"
                rows={1}
          ...
          <p className="mt-3 text-center text-xs text-zinc-500">
            <kbd className="rounded bg-[#0d1424]/80 px-1.5 py-0.5 text-zinc-400 shadow-sm">
              Enter
            </kbd>{" "}
            发送
        ...
        >
          <div className="flex items-center justify-center gap-2 text-xs uppercase tracking-[0.24em] text-zinc-500">
            ...
            {promptPresets.map((preset) => {
              ...
              return (
                <button
                  ...
                  className={cn(
                    "group rounded-2xl border border-white/70 bg-[#0d1424]/70 p-4 text-left shadow-sm transition-all duration-200 hover:-translate-y-0.5 hover:border-violet-400/60 hover:shadow-md",
                ...
                >
                  ...
                  <div className="mt-3 flex items-center gap-2 text-xs text-zinc-500">
                    ...
                    <ArrowUpRight className="h-3.5 w-3.5 text-zinc-500 transition-colors group-hover:text-cyan-300" />
                  </div>
                </button>
              );
            })}
