    ...
    <div className="group flex">
      <div className="min-w-0 flex-1 space-y-4">
        ...
        {!isThinking && hasThinking ? (
          <div className="overflow-hidden rounded-lg border border-violet-400/60 bg-violet-500/25">
            <button
              type="button"
              onClick={() => setThinkingExpanded((prev) => !prev)}
              className="flex w-full items-center gap-2 px-4 py-3 text-left transition-colors hover:bg-violet-400/15"
            >
              <div className="flex flex-1 items-center gap-2">
                ...
                {thinkingDuration ? (
                  <span className="rounded-full bg-violet-500/25 px-2 py-0.5 text-xs text-violet-300">
                    {thinkingDuration}
                  </span>
                ) : null}
              </div>
            ...
            {thinkingExpanded ? (
              <div className="border-t border-violet-400/60 px-4 pb-4">
