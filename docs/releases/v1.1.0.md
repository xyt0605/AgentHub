Agenthub 1.1.0 是继 1.0.x 之后的首个功能版本，围绕混合检索、摄取内核、回答溯源、Prompt 运行时管理和业务审计五个方向进行了系统性升级，同时对模型路由、对象存储和检索架构做了结构性调整。
...
|---|---|---|
| `app.demo-mode` | `agenthub.demo-mode` | 命名空间迁移 |
| `app.eval.enabled` | `agenthub.eval.enabled` | 命名空间迁移 |
